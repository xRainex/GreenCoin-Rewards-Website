<?php
    ...
    $locationQuery = "SELECT * FROM location ORDER BY location_name";
...
<body>
    ...
    <?php
        if(isset($_POST['submitBtn'])){
            ...
            if (!mysqli_query($con,$sql_insert)){
                ...
                $admin_announcement = "A user has submitted a dropoff request. Please review and process it accordingly.";
                $newRequestNotiQuery = "INSERT INTO admin_notification(user_id, datetime, title, announcement, status) VALUES 
                ('$user_id', NOW(), '📦 New Dropoff Request Received!', '$admin_announcement', 'unread')";
                mysqli_query($con, $newRequestNotiQuery);

                echo "<script>window.location.href = 'User-Drop-off Points.php';</script>";
            }
        }
    ?>
    ...
    <div class="stickman-container">
        <img 
            ...
            style="margin-left: 500px; margin-top: -40px; margin-bottom: -11px; cursor: pointer;" 
            src="User-Drop-off Points-Stickman.svg" 
            width="570"
        >
    </div>
