...
<body>
    ...
    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['redeemBtn']) ) {
            ...
            if ($result) {
                $admin_announcement = "A user has redeemed $rewardName. Please ensure the reward is prepared and available for collection at all designated dropoff points.";
                ...
                if ($updateRewardResult && $updateUserResult && $insertRedeemResult) {
                    echo "<script>window.location.href = 'User-Rewards.php';</script>";
                } else {
