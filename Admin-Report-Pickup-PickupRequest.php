...
<body>
    ...
    <div class ="main-content">
        <h2 class="header">Pickup Requests Report</h2>
        <div class="report-container">
            ...
            <form action="Admin-Report-Pickup-PickupRequest-PDF.php" method="post">
    ...
    <script>
        ...
        function filterDataByYear(year) {
            ...
            return pickupData.filter(item => item.year === year);
        }
        ...
        function updateChart(year) {
            ...
            if (filteredData.length === 0) {
                pickupChart.data.labels = [];
                pickupChart.data.datasets[0].data = [];
            } else {
                pickupChart.data.labels = filteredData.map(item => {
                    let monthNum = item.month.toString().padStart(2, "0"); 
                    return monthNames[monthNum] || monthNum; 
                });

                pickupChart.data.datasets[0].data = filteredData.map(item => item.total_pickups);
            }
        ...
        let pickupChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: initialData.map(item => item.total_pickups),
        ...
        document.getElementById("yearFilter").addEventListener("change", function () {
            ...
            pickupChart.data.datasets[0].backgroundColor = Array(pickupChart.data.labels.length).fill(defaultColor);
        ...
        document.getElementById("monthFilter").addEventListener("change", function () {
            ...
            let newColors = pickupChart.data.labels.map(() => defaultColor);

            if (selectedMonth !== "") { 
                let selectedMonthName = monthNames[selectedMonth]; 
                
                pickupChart.data.labels.forEach((label, index) => {
            ...
            pickupChart.data.datasets[0].backgroundColor = newColors;
            pickupChart.update();
            applyFilters();
        });
