<?php
    ...
    if(isset($_POST['login'])){
        ...
        $userExistQuery = mysqli_query($conn, "SELECT admin_id, password FROM admin WHERE email = '$email'"); 
            ...
            echo '<div class="overlay">
                    <div class="popup-error">
                        <div class="error-message-container">
                            ...
                            <button class="close" type="button" onclick="closePopup()">OK</button>
                        </div>
                    </div>
                </div>';   
        } else {
            if ($password == $userExistResult['password']) {
                $_SESSION['user_id'] = $userExistResult['admin_id'];
...
<head>
    ...
    <style>
        ...
        *{
        ...
        h1 {
            font-size: 35px;
            padding-left: 5px;  /* You can remove or adjust this */
            padding-bottom: 20px;
            padding-top: 90px;
        ...
        h2 {
            font-size: 18px;
            padding-left: 5px;  /* You can adjust or remove this */
            padding-bottom: 60px;
            font-weight: normal;
    ...
    <div class="login-div" id="login-div">
        <form id="login" action="#" method="post">
            <div class="login-form">
                <h1>Welcome Back!</h1>
                <h2>You are entering GreenCoin's secured services section. You need to have a valid Email and password in order to gain access to the services.</h2>
                <div style="margin: 0px 20px;">
                    <label class="email">Email</label>
                    <br>
                    <input type="text" name="loginEmail" placeholder="Email"  class="inputFields">
                    ...
                    <div style="position: relative;">
                        <input type="password" name="loginPW" placeholder="Password" class="inputFields">
