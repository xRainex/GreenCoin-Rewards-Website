<?php
    ...
    function deleteFromGoogleDrive($fileId) {
        try {
            ...
            error_log("Google Drive Deletion Failed: " . $e->getMessage()); // Log instead of echo
            return false;
        }
    }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["rewardImage"])) {
        ...
        if ($fileID) {
            ...
            echo "File upload to Google Drive failed.";
        }
    }
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["rewardID"])) {
        ...
        if (mysqli_query($conn, $updateQuery)) {
            echo "<script>alert('Reward updated successfully!'); window.location.href='Admin-RewardsItemsPage.php';</script>";
        } else {
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["deleteReward"])) {
        ...
        if ($checkResult->num_rows > 0) {
            $updateQuery = "UPDATE reward SET status = 'Unavailable' WHERE reward_id = '$rewardID'";
            if ($conn->query($updateQuery) === TRUE) {
                echo json_encode(["status" => "success", "message" => "Reward is linked to redemptions. Marked as Unavailable."]);
            } else {
...
<div class="container">
    ...
    <div class ="main-content">
        ...
        <div id="edititem-container" class="editItemBox">
            <div class="edititem-content">
                ...
                <form id="editForm" enctype="multipart/form-data" method="POST">
                    ...
                    <input type="file" id="editImage" name="newImage">
    ...
    <script>// Switch Tab Function
        ...
        // Ellipsis Button Dropdown Functionality
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.ellipsis-btn').forEach(button => {
                button.addEventListener('click', function(event) {
                    ...
                    document.querySelectorAll('.itemdropdown-menu').forEach(menu => {
                        if (menu !== dropdown) {
        ...
        document.addEventListener("DOMContentLoaded", function() {            
            ...
            const editContent = document.querySelector(".edititem-content");
            ...
            document.querySelectorAll(".edit-btn").forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    setTimeout(() => {
                        ...
                        editContent.style.transform = "scale(1)";
                    }, 10);  
                });
            });
            ...
            function closeEditModal() {
                ...
                editContent.style.transform = "scale(0.9)";  
                setTimeout(() => {
            ...
            document.getElementById("editForm").addEventListener("submit", function (event) {
                ...
                formData.append("rewardID", document.getElementById("editRewardID").value);
                ...
                formData.append("category", document.getElementById("editCategory").value); // Add category here

                const fileInput = document.getElementById("editImage");
                if (fileInput.files.length > 0) {
                    formData.append("newImage", fileInput.files[0]);  // Append the image if it is provided
                }
                ...
                .finally(() => {
                    delete this.dataset.submitting; // Allow further submissions
                });
            });
