...
<head>
    <meta charset="UTF-8">
    <title>First Time Users Report</title>
...
<body>
    ...
    <div class ="main-content">
        <h2 class="header">First Time Users Report</h2>
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($row['recent_service']); ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
            <form action="Admin-Report-Users-FirstTimeUsers-PDF.php" method="post">
