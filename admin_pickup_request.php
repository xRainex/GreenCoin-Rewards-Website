...
<body>
    ...
    <div class="content">
        ...
        <div class="upperbutton">
            <button class="pending">Pending Request</button>
        ...
        <div class="detail-card">
            ...
            <table id="request_table">
                <tr>
                    ...
                    <th stlye="width:20%;">Request Date</th>
                ...
                ?>
                <tr class="row_hover" onclick="window.location.href='admin_pickup_request_detail.php?pickup_request_id=<?php echo $row['pickup_request_id'];?>'">
                    <td><?php echo $counter++; ?></td>
                    <td><?php echo $row['username'];?></td>
                    <td><?php echo date('d M Y H:i', strtotime($row['datetime_submit_form'])); ?></td>
