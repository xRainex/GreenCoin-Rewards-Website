...
<body>
    ...
    <div class="content">
        ...
        <div>
            ...
            <button class="assign">Assigned Request</button>
            <button class="complete" onclick="window.location.href='admin_complete_request.php'">Completed Request</button>
        </div>
        <div class="detail-card">
            ...
            <table id="assigned_table">
                ...
                ?>
                <tr class="row_hover" onclick="window.location.href='admin_pickup_assign_detail.php?pickup_request_id=<?php echo $row['pickup_request_id'];?>'">
                <td><?php echo $counter++; ?></td>
                    <td><?php echo $row['username'];?></td>
                    <td><?php echo date('d M Y', strtotime($row['pickup_date'])); ?></td>
                    <td><?php echo date('H:i', strtotime($row['pickup_time'])); ?></td>
                    <td><?php echo $row['driver_name'];?></td>
                    <td><span class="status-badge status-assigned"><?php echo ucfirst($row['status']); ?></span></td>                
                    <?php
                }
                ?>
            </table>
    ...
    <script>
        ...
        function filterByDate() {
            ...
            for (let i = 1; i < rows.length; i++) {
                ...
                const rowPickupDate = cells[2].textContent.trim(); 
