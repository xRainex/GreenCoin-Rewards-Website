...
<body>
            ...
            if ($_POST['action'] === 'assign_driver') {
                ...
                if ($point_data) {
                    ...
                    try {
                        ...
                        $announcement = "Your pickup request has been processed! You have earned {$points} points for your recycling effort. Thank you for making a difference!";                     
                        $notificationQuery = "INSERT INTO user_notification(user_id, datetime, title, announcement, status) 
                                            VALUES ('$user_id', NOW(), 'Pickup Request Completed', '$announcement', 'unread')";
    ...
    <div class="content">
        ...
        <button class="back" type=submit name="back" onclick="window.location.href='admin_pickup_assign.php'"><i class="fa-solid fa-arrow-left"></i> Back to List</button>
        ...
        <div class="user-detail">
            <div class="action-buttons">
                <button type="submit" class="assign-button" onclick="openAssignPointModal()">
