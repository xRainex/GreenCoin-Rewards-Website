...
<head>
    <meta charset="UTF-8">
    <title>Drop Off Locations Report</title>
...
<body>
    ...
    <div class ="main-content">
        <h2 class="header">Drop Off Locations Report</h2>
        <div class="report-container">
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($dropOffLocations as $row) : ?>
                        <tr>
            ...
            <form action="Admin-Report-DropOff-DropOffLocations-PDF.php" method="post">
