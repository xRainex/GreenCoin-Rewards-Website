...
<body>
    ...
    <?php
        ...
        if(mysqli_connect_errno()){
            ...
            WHERE dropoff.status = 'Completed'";
    ...
    <div class="content">
        ...
        <div>
            <button class="today" onclick="window.location.href='admin_dropoff.php'">Dropoff Requests</button>
            <button class="all" >Completed Requests</button>
        </div>  
        <div class="detail-card">
            ...
            <table id="assigned_table">
                ...
                ?>
                <tr class="row_hover" onclick="window.location.href='admin_dropoff_complete_detail.php?dropoff_id=<?php echo $row['dropoff_id'];?>'">
